...
dir <-  paste(wdir,site,"/",stade,sep="")
if (file.exists(dir)){
  load(paste0(stade,"/results/Results_",stade,"_",year+1,".RData"))
...
### Total number of returns
plot(NULL,xlim=c(1,data$Nyears),ylim=c(0,10000),bty="n",ylab="Total number of smolts",xaxt="n",xlab="")

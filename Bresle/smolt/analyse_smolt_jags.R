...
#}
#load(paste('inits/inits_bugs_',stade,year,'.Rdata',sep="")) # chargement des inits
...
#pp.check(all, actual = 'fit', new = 'fit.new')

#save(samplesList,file=paste0("results/sinusoidal_rivers/on_data_ThirelG/pred_flow_single_constant_AR_nimble_",pops[pop],".Rdata"))
fit.mcmc<-out$samples

...
pdf(paste('results/PosteriorCheck_',stade,"_",year,'.pdf',sep=""))
...
par(mfrow=c(2,1))
# 1SW
caterplot(fit.mcmc,paste0("epsilon_MC[",1:Nyears,",1]"), reorder = FALSE, horizontal=FALSE, style=c("plain")) 
# MSW
caterplot(fit.mcmc,paste0("epsilon_MC[",1:Nyears,",2]"), reorder = FALSE, horizontal=FALSE, style=c("plain")) 

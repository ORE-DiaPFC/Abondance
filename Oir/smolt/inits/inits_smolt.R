...
inits_fix <- list(
  ## NO UPDATE
  log_cess_MC = runif(1,-.3,0),#-0.2224,
  rate_lambda = runif(1,0,0.01),#0.00248,
  shape_lambda = runif(1,2,3),#2.893,
  logit_flow_MC = runif(1,-.7,0),#-0.55,
  logit_int_MC = runif(1,.1,0.9)#0.7
)

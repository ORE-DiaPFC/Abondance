...
### Total number of returns
plot(NULL,xlim=c(1,max(p)),ylim=c(0,20),bty="n",ylab="Mean flow observed in December",xaxt="n",xlab="")
axis(side=1,line=1,labels = years,at=1:data$Y, las=2, cex=.5)
...
p<-1:data$Y_last
### Total number of returns
plot(NULL,xlim=c(1,max(p)),ylim=c(0,35000),bty="n",ylab="Total number of parr",xaxt="n",xlab="")
axis(side=1,line=1,labels = years,at=p, las=2, cex=.5)
...
### Total number of returns
plot(NULL,xlim=c(0,1500000),ylim=c(0,35000),bty="n",ylab="Recruitment (parr 0+)",xlab="Stock (eggs produced)")
#axis(side=1,line=1,labels = years,at=p, las=2, cex=.5)

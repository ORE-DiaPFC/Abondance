...
if (file.exists(dir)){
 ...
 # table[4:nrow(table),2] <- round(n_parr,0) # 1995 to now
    sum <- read.table(paste0(stade,"/results/YOYnat.txt"), h=TRUE)
...
p <- 1:data$Y
plot(NULL,xlim=c(1,max(p)),ylim=c(100000,1500000),bty="n",ylab="Total number of eggs produced",xaxt="n",xlab="")
axis(side=1,line=1,labels = years,at=p, las=2, cex=.5)
# N total
...
p <- 1:data$Y
plot(NULL,xlim=c(1,max(p)),ylim=c(5000,700000),bty="n",ylab="Number of eggs produced",xaxt="n",xlab="")
axis(side=1,line=1,labels = years,at=p, las=2, cex=.5)
...
### Total number of returns
plot(NULL,xlim=c(1,max(p)),ylim=c(0,15),bty="n",ylab="Mean flow observed in December",xaxt="n",xlab="")
axis(side=1,line=1,labels = years,at=1:data$Y, las=2, cex=.5)
...
### Total number of returns
plot(NULL,xlim=c(0,1500000),ylim=c(0,20000),bty="n",ylab="Recruitment (parr 0+)",xlab="Stock (eggs produced)")
#axis(side=1,line=1,labels = years,at=p, las=2, cex=.5)
...
text(s[1:(nrow(s)-1),"50%"],r[2:nrow(r),"50%"]+1000,labels = 1987:2019, cex=.5) # year of parr cohort

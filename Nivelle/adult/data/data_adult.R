...
################################################################################
REDDS <- read.table(paste("data/data_REDDS_",year,".txt",sep=""),header = TRUE, check.names=FALSE,comment.char = "#",colClasses="character")
...
Q <- read.table(paste("data/data_Q_",year,".txt",sep=""),header = TRUE, check.names=FALSE,comment.char = "#",colClasses="character")
...
eff <- read.bugsdata(paste("data/data_eff_",year,".txt",sep=""))
eff_Ux <- eff$eff_Ux 
eff_Ol <- eff$eff_Ol
...
################################################################################																															
dead <- read.table(paste("data/data_dead_",year,".txt",sep=""),header = TRUE, check.names=FALSE,comment.char = "#",colClasses="character")
...
################################################################################							
Ol <- read.table(paste("data/data_Ol_",year,".txt",sep=""),header = TRUE, check.names=FALSE,comment.char = "#",colClasses="character")
...
################################################################################
Ux <- read.table(paste("data/data_Ux_",year,".txt",sep=""),header = TRUE, check.names=FALSE,comment.char = "#",colClasses="character")
...
################################################################################
age <- read.table(paste("data/data_age_",year,".txt",sep=""),header = TRUE, check.names=FALSE,comment.char = "#",colClasses="character")
...
################################################################################			
EHC <- read.table(paste("data/data_EHC_",year,".txt",sep=""),header = TRUE, check.names=FALSE,comment.char = "#",colClasses="character")
...
################################################################################
nm_num <- read.table(paste("data/data_nm-num_2_",year,".txt",sep=""),header = TRUE, check.names=FALSE,comment.char = "#",colClasses="character")
...
################################################################################
NB <- read.table(paste("data/data_NB_",year,".txt",sep=""),header = TRUE, check.names=FALSE,comment.char = "#",colClasses="character")

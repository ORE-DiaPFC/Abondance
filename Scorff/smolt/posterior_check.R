...
par(mfrow=c(1,1))
caterplot(fit,paste0("p1y[",1:data$Nyears,"]"), reorder = FALSE, horizontal=FALSE, style=c("plain")) 

par(mfrow=c(2,1))
caterplot(fit,paste0("p_male[",1:data$Nyears,",1]"), reorder = FALSE, horizontal=FALSE, style=c("plain"),labels = 1995:2023); title("Prop Male smolts 1+")
abline(h=0.5,lty=2)
caterplot(fit,paste0("p_male[",1:data$Nyears,",2]"), reorder = FALSE, horizontal=FALSE, style=c("plain"),labels = 1995:2023) ; title("Prop Male smolts 2+")
abline(h=0.5,lty=2)

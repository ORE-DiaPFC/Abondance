...
### Total number of returns
plot(NULL,xlim=c(0,50000),ylim=c(0,20000),bty="n",ylab="Smolt",xlab="Tacon 0+")
...
text(r[2:28,"50%"],smolt[1:27,"50%"],labels = years, cex=.5)



plot(NULL,xlim=c(1,28),ylim=c(0,1),bty="n",ylab="Parr to Smolt survival",xlab="Cohort",xaxt="n")
axis(side=1,line=1,labels = 1994:2020,at=1:27, las=2, cex.axis=.7)
points(1:27,smolt[1:27,"50%"]/r[2:28,"50%"],col=mycol[1],pch=21,bg=paste0(mycol[1]))
